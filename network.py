...
def create_network(battery_specs_file, prices, year):
    ...
    print("Battery specs loaded successfully.")
    ...
    network.add("Link", "SS_to_Household", bus0="SS", bus1="Household", p_nom=20, marginal_cost=10, carrier="electricity")
    network.add("Link", "Household_to_SS", bus0="Household", bus1="SS", p_nom=20, carrier="electricity")
   
    network.add("Link", "Household_to_BESS",
                bus0="Household", bus1="Household",  # Corrected: Both ends connect to Household
                p_nom=battery_specs["charge_power_mw"],
                efficiency=battery_specs["charge_efficiency"],
                carrier="electricity")  # Assign carrier
